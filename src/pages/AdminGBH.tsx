    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-semibold">Dossiers conformes</h2>
              ...
              <tr className="bg-gray-100">
                {columns.map((col) => (
                  <th key={col} className="px-4 py-2 text-left capitalize">
                    {col === "created_at" ? "Soumis le" : col.replace(/_/g, " ")}
                  </th>
                ))}
        ...
        {showAll && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white p-6 rounded shadow max-h-[90vh] overflow-auto w-[90vw] max-w-5xl">
              ...
              <button onClick={() => setShowAll(false)} className="mt-4 bg-blue-600 text-white px-4 py-2 rounded">
                Fermer
              </button>
            </div>
          </div>
