    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 max-w-3xl w-full mx-4 relative overflow-y-auto max-h-[90vh]">
        ...
        <div className="space-y-4 text-gray-700 text-sm md:text-base">
          ...
          <h3 className="font-semibold mt-6">4. Modalités de soutien</h3>
          <p>Les exploitations sélectionnée peuvent bénéficier d’un soutien à hauteur de 20 000 € par projet. Le comité de sélection peut couvrir un montant supérieur sous réserve de motivation et de fonds suffisants.</p>
          <p>Les candidats ont le choix entre 5 options :</p>
          <ol className="list-decimal list-inside ml-4 space-y-1">
            <li>KIT 1 : Petite structure agricole légère : abri en bois ou en bambou, cuve de 1300 L, kit solaire, goutte à goutte ;</li>
            <li>KIT 2 : Collecte et stockage d’eau de pluie : citernes souples 50 m³ + 30 m³, gouttières, irrigation ;</li>
            <li>Grande réserve en zone côtière : watertank 98 m³, résistant à l’air salin;</li>
            <li>Réparation après sinistre, sur devis ;</li>
            <li>Solution sur-mesure à vos besoins, sur devis.</li>
          </ol>
          <p>Les options 1, 2 et 3, sont fournies par un prestataire de Super-Novae, il n'est donc pas nécessaire de soumettre un devis lors de la candidature, pour ces trois choix.</p>
          <p>Pour les options 4 et 5, il est obligatoire de fournir un devis détaillé lors du dépôt du dossier de candidature.</p>
          <p>Concernant, l’option 5:</p>
